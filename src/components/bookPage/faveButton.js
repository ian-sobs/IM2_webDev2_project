...
export default function faveButton(props){
    ...
    if(faved){
        return (
            <>
                <button className="bg-red-400 py-[6px] px-[9px] rounded-full text-white font-semibold flex flex-row items-center" onClick={unFave}>
    ...
    return (
        <>
            <button className="bg-slate-200 py-[6px] px-[9px] rounded-full text-red-400 hover:bg-red-400 fill-red-400 hover:fill-white hover:text-white font-semibold flex flex-row items-center" onClick={fave}>
