...
export default function faveButton(props){
    ...
    return (
        <>
            <button className="bg-slate-200 py-[6px] px-[9px] rounded-full text-black hover:bg-red-400 fill-[#000000] hover:fill-white hover:text-white font-semibold flex flex-row items-center" onClick={fave}>
