...
export default function Page(){
    ...
    <>
    {/* space-x-9 space-y-9 */}
        <section className="min-h-screen bg-white pt-[25px] px-9 sm:px-11 md:px-14 lg:px-20 flex flex-wrap justify-between">
            {/* <div className="flex flex-wrap justify-evenly"> lg:justify-between  alg:justify-center alg2:justify-between */}
